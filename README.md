# tommy teaches tommy: PyGame (`2.6.z`) Game Development

__tommy teaches tommy__ (_and anyone else who cares to read all this_) about software development and coding with `pygame` for create videogames.

(`pygame`)[https://www.pygame.org/news] is a free and open-source Game Development SDK for Python.
...
- [Run the Example Games](#run-the-example-games)
    - [Checkers](#checkers)
...
<a id="run-the-example-games"></a>
## Run the Example Games

This repository contains multiple example games, so the subsections here explain how to run each of the games and gives details on basic rules and functionality.
